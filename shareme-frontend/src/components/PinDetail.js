...
const PinDetail = () => {
  ...
  if (!pinDetail) return <Spinner message="Loagind pin." />

  return (
    <>
      <div className='flex xl-flex-row flex-col m-auto bg-white' style={{ maxWidth: '1500px', borderRadius: '32px' }}>
        <div className='flex justify-center items-center md:items-start flex-initial p-10'>
          <img
        ...
        <div className='w-full p-5 flex-1 xl:min-w-620'>
          ...
          <div>
            ...
            <p className='mt-3'>Category: {pinDetail.category}</p>
          </div>
