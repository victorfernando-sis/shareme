                        ...
                        <div className='flex justify-between items-center gap-2 w-full'>
                            {destination && (
                                <a
                                    ...
                                    target='_blank'
                                    rel='noreferrer'
                                    className='bg-white flex items-center gap-2 text-black font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:100 hover:shaddow-md'
                                >
                                    <BsFillArrowUpRightCircleFill />
                                    {destination.replace('https://', '').slice(0,15)}...
                                </a>
                            )}
